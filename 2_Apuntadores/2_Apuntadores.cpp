// 2_Apuntadores.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
//
...
void Promedio(int argc, char** argv)
{
    ...
    *(x + 1) = 18;
    ...
    //lista de 100 enteros aleatorios
    // sacar el promedio
    ...
    *cumulus = 0.0;
    ...
    for (int i = 0; i < 100; i++)
    {
        std::cout << "Pon un numero porfavor \n";
        std::cin >> y[i];
        ...
        if (y[i] > 0 && y[i] < 2147483647)
        {
            ...
            *cumulus += 1.0;
            ...
            std::cout << "Desea continuar yes/no? \n";
            std::cin >> isit;
            ...
            {
                std::cout << "Gracias por su participacion, el promedio es \n";
                break;
            }
            else
            {
...
int main(int argc, char** argv)
{
    ...
    std::cout << "2. Promedio \n";
    std::cout << "Ingresa el numero de la funcion que deseas \n";
